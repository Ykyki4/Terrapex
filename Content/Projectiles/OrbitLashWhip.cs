...
{
	// OrbitLashWhip.png, the same vertical strip every whip in the mod uses:
	//   y 0  h 26  handle
	//   y 26 h 16  link, thick
	//   y 42 h 16  link, thin
	//   y 58 h 16  link, glowing
	//   y 74 h 18  tip
	public class OrbitLashWhip : ModProjectile
	{
		...
		public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
		{
			...
			target.AddBuff(ModContent.BuffType<Cracked>(), 240);
		...
		public override bool PreDraw(ref Color lightColor)
		{
			...
			for (int i = 0; i < points.Count - 1; i++)
			{
				...
				if (i == points.Count - 2)
				{
					...
					scale = MathHelper.Lerp(0.6f, 1.7f,
