...
{
	// GlassthreadWhip.png, same vertical strip every whip in the mod uses:
	//   y 0  h 26  handle
	...
	//   y 74 h 18  tip
	//
	// Its tag is crit, not damage: the Dust Lash already sells raw tag damage, and a
	// second whip that does the same thing louder is not a second whip.
	public class GlassthreadWhip : ModProjectile
	{
		/// <summary>Crit chance the tag hands to every minion hitting the tagged target.</summary>
		...
		public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
		{
			...
			target.AddBuff(ModContent.BuffType<Buffs.GlassthreadTag>(), 240);
